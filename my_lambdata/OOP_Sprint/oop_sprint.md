...
1_: In my opinion, the important parts of code reviews are: the code passes the static analysis It passes all the tests.It has been styled and well commented.i would appreciate if others respect my code and give me humble feedback.

2:- Container help us  shift existing applications into modern operating system.it help us in refactoring the applications.it increases portability and privide greater efficiency/
